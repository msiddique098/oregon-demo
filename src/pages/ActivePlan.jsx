...
import { ArrowDownToLine, BadgePercent, Check, Crown, Radio, ShieldCheck, Zap } from "lucide-react";
...
export default function ActivePlan() {
    ...
    const signalsPerDay = Number(activePlan?.signals_per_day || user?.signals_per_day || 0);
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5">
                        <div>
                            ...
                            <p className="text-sm text-zinc-400 mt-5 max-w-2xl">
                                Your active plan controls daily option trade signals, daily plan-owner rewards, priority withdrawal timing, task boosts, and referral commission benefits.
                            </p>
                        </div>
                    ...
                    {sortedPackages.map((plan) => {
                        ...
                        return (
                            <div key={plan.id} className={`glass-strong p-5 relative overflow-hidden ${isCurrent ? "border-amber-500/40 neon-gold" : ""}`}>
                                ...
                                <p className="text-sm text-emerald-300 mt-1">{Number(plan.signals_per_day || 0)} signals/day - 9% daily</p>
