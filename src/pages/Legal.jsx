...
export function Terms() {
    return <LegalPage title="Terms & Conditions" updated="June 12, 2026" intro="These terms explain how Eregon Marketing accounts, plans, rewards, deposits, and withdrawals are managed."
        sections={[
            ...
            { h: "Membership plans", b: "Plans provide platform benefits such as daily option trade signals, priority withdrawal review, task boosts, badges, and referral commission benefits. Plan availability, pricing, perks, and duration may change over time and are shown before a user submits a plan deposit request.", items: ["A plan is not active until the related deposit proof is reviewed and approved by an authorized admin.", "Rejected or incomplete plan submissions do not activate plan benefits.", "Daily option trade signal allowances are assigned after the related plan deposit is approved."] },
            ...
            { h: "Tasks and rewards", b: "Task rewards, referral commissions, bonuses, and plan benefits are recorded through platform workflows. Rewards may be adjusted, delayed, rejected, or reversed if they are linked to duplicate accounts, invalid activity, manipulation, or incomplete requirements." },
...
export function Privacy() {
    return <LegalPage title="Privacy Policy" updated="June 12, 2026" intro="This policy explains what information Eregon Marketing collects, why it is used, and how account data is protected."
        sections={[
            { h: "Information we collect", b: "We collect the information needed to operate user accounts, plans, deposits, rewards, withdrawals, and support workflows.", items: ["Account details such as name, email address, registration code, referral code, role, and account status.", "Security data such as hashed passwords, session tokens, login state, and account activity timestamps.", "Wallet and transaction details submitted by users, including deposit proof images, transaction hashes, withdrawal addresses, selected coins, and requested amounts.", "Platform activity such as task submissions, reward records, plan status, trade signal access, notifications, admin decisions, and support messages."] },
