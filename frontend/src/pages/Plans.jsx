        ...
        <div className="min-h-screen bg-[#050505] text-white">
            ...
            <section className="relative max-w-7xl mx-auto px-6 lg:px-12 py-16 md:py-20">
                ...
                <div className="relative text-center max-w-3xl mx-auto mb-12">
                    ...
                    <p className="text-zinc-400 mt-4">Choose a membership plan and unlock daily plan rewards, spin-wheel attempts, priority withdrawals, and referral perks.</p>
                </div>
                    ...
                    {packages.map((p, idx) => {
                        ...
                        return (
                            <div key={p.id} data-testid={`plan-card-${p.tier}`}
                                ...
                                <p className="text-sm text-emerald-300 mt-1">{p.spin_tokens || 0} included spins - 9% daily</p>
