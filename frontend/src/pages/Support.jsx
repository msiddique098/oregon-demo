    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white">
            ...
            <section className="max-w-4xl mx-auto px-6 lg:px-12 py-16 md:py-20">
                <p className="text-xs uppercase tracking-widest text-amber-400/80 mb-3">Eregon Marketing Support</p>
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-10">
                    <div className="glass-strong p-6"><Mail className="w-5 h-5 text-amber-300 mb-3" /><p className="font-semibold">Email</p><p className="text-sm text-zinc-400 mt-1">support@eregon.online</p></div>
                ...
                <form className="glass-strong p-6 md:p-8 mt-8 space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Message received. Support will respond."); }}>
                    ...
                    <input className="input-eregon" placeholder="Your name" />
                    <input type="email" className="input-eregon" placeholder="Your email" />
                    <textarea className="input-eregon min-h-[120px]" placeholder="How can we help?" />
                    <button className="btn-eregon" type="submit">Send to Support</button>
                </form>
            </section>
            <Footer />
        </div>
