        ...
        <AdminLayout>
            <div className="flex items-center justify-between flex-wrap gap-3">
                <div>
                    ...
                    <h1 className="text-3xl md:text-4xl font-display font-semibold mt-1">Support Inbox</h1>
                </div>
...
export function AdminLiveFeed() {
    ...
    return (
        <AdminLayout>
            ...
            <h1 className="text-3xl md:text-4xl font-display font-semibold mt-1">Royal Feed Curator</h1>

            <div className="grid lg:grid-cols-3 gap-5 mt-6">
                <div className="glass-strong p-6">
                    <h3 className="font-display text-lg mb-3">Auto-feed settings</h3>
                    <label className="flex items-center justify-between p-3 rounded-xl bg-black/40 border border-white/5">
            ...
            <div className="glass-strong p-6 mt-6">
                ...
                <div className="space-y-2">
                    {items.map(it => (
                        <div key={it.id} className="flex items-center justify-between p-3 bg-black/40 border border-white/5 rounded-xl">
                            <div>
...
export function AdminBulk() {
    ...
    return (
        <AdminLayout>
            ...
            <h1 className="text-3xl md:text-4xl font-display font-semibold mt-1">Mass Operations</h1>
