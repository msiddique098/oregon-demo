        ...
        <div className="min-h-screen bg-[#050505] text-white">
            ...
            <section className="relative max-w-5xl mx-auto px-6 lg:px-12 py-16 md:py-24">
                ...
                <div className="relative">
                    <p className="text-xs uppercase tracking-widest text-amber-400/80 mb-3">About Eregon Marketing</p>
                    ...
                    <p className="text-zinc-400 mt-6 max-w-2xl">
                        Eregon Marketing is a task reward platform that manages task submissions, approvals, plans, and reward balances.
                        Balances, tasks, plans, and commissions are managed through the Eregon Admin Console and shown according to account permissions.
                        We deliver a clean dashboard for task campaigns, membership plans, reviews, and reward tracking.
                    </p>

                    <div className="grid md:grid-cols-2 gap-4 mt-12">
                        {[
                            { icon: Crown, title: "Eregon Aesthetic", desc: "Glassmorphism, gold highlights and purple neon throughout every surface." },
                            ...
                            { icon: Trophy, title: "Five Growth Tiers", desc: "From Basic to Elite VIP — each tier unlocks elite perks and faster withdrawals." },
                        ].map((it, i) => (
